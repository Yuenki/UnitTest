//https://github.com/Yuenki
//
//Modified By Duyen Ky Tran
//Date: April 11, 2019
//Purpose: Unit Test of the vec_length function
//
...
void unit_Test_Vlength() {
    ...
    v[0] *= oolen;
    v[1] *= oolen;
    printf("%3i  %8.5lf  %8.5lf  %10.5lf %8.5lf \n", i+1, data[0], data[1], data[2], data[3], data[5], ret);
...
int main(int argc, char *argv[])
{
    ...
    printf("     --------  --------  ----------  ---------\n");
    unit_Test_Vlength(argc); //unit test function
    printf("\nProgram complete.\n\n");
